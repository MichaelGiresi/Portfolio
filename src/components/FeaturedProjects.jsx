    ...
    <div className='fp-container'>
      ...
      <div className='fp-info1-container'>
        ...
        <div className='fp-info1-info'>
          <p className='fp-info1-info-p'>Matchbox Stickers is a limited quanity e-commerce website. <span id="mbs-info-span">Talented artists from around the world sell a limited quanity of their creations.</span>
          </p>
      ...
      <div className='fp-showcase-container'>
        <div className='fp-showcase-1' id="fp-showcase-mbs-1"><a href='https://stupendous-puppy-0e318b.netlify.app' rel='noopener' target = '_blank' className='fp-showcase-button'>VISIT THE SITE</a>
        </div>
